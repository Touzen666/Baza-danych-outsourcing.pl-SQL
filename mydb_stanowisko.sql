...
CREATE TABLE `stanowisko` (
  ...
  `nazwaStanowiska` varchar(45) NOT NULL,
  `opisStanowiska` varchar(500) NOT NULL,
  `idWczesniejszaPraca` int(11) DEFAULT NULL,
  PRIMARY KEY (`idStanowisko`),
  UNIQUE KEY `idStanowisko_UNIQUE` (`idStanowisko`)
...
-- Dump completed on 2019-01-13 18:29:28
